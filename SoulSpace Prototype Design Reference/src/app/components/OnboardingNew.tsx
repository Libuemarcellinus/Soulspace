...
import { RefreshCw, Sparkles, Lock, AlertCircle, BookOpen, MessageCircle, Edit3 } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 px-6 py-8 flex flex-col max-w-[390px] mx-auto">
        ...
        >
          <p className="text-slate-400 text-sm text-center">
            Format: <span className={`bg-gradient-to-r ${moodColors[selectedMood]} bg-clip-text text-transparent`}>
              [Mood][Word][Number]
            </span>
          </p>
              ...
              {suggestions.map((suggestedUsername, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className={`bg-gradient-to-r ${moodColors[selectedMood]} bg-clip-text text-transparent`}>
                      {suggestedUsername}
                    </span>
